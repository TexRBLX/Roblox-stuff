...
do
    --- Gets the asset ID for a given asset name.
    -- @param AssetName string The name of the asset to get.
    -- @return string? The rbxassetid of the asset, or nil if not found.
