...
local drawingUI = Instance.new("ScreenGui", cloneref(game:GetService("CoreGui")))
...
local drawingFontsEnum = {
	[0] = Font.fromEnum(Enum.Font.RobotoMono),
...
function DrawingLib.new(drawingType)
	...
	if drawingType == "Line" then
		...
		lineFrame.BackgroundTransparency = math.clamp(1 - lineObj.Transparency, 0, 1)
	...
	elseif drawingType == "Text" then
		...
		textLabel.TextTransparency = math.clamp(1 - textObj.Transparency, 0, 1)
	...
	elseif drawingType == "Circle" then
		...
		circleFrame.BackgroundTransparency = (if circleObj.Filled then math.clamp(1 - circleObj.Transparency, 0, 1) else 1)
		...
		return setmetatable(table.create(0), {
			__newindex = function(_, index, value)
				...
				elseif index == "Filled" then
					circleFrame.BackgroundTransparency = (if value then math.clamp(1 - circleObj.Transparency, 0, 1) else 1)
	...
	elseif drawingType == "Square" then
		...
		squareFrame.BackgroundTransparency = (if squareObj.Filled then math.clamp(1 - squareObj.Transparency, 0, 1) else 1)
		...
		return setmetatable(table.create(0), {
			__newindex = function(_, index, value)
				...
				elseif index == "Filled" then
					squareFrame.BackgroundTransparency = (if value then math.clamp(1 - squareObj.Transparency, 0, 1) else 1)
					uiStroke.Enabled = not value
	...
	elseif drawingType == "Image" then
		...
		imageFrame.ImageTransparency = math.clamp(1 - imageObj.Transparency, 0, 1)
